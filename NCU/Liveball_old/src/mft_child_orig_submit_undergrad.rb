...
describe "SubmitUndergrad" do
  ...
  it "test_submit_undergrad" do
    @driver.get(@base_url + "/MFT_Child_Original//?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
    # Warning: assertTextPresent may require manual changes
    @driver.find_element(:tag_name => "body").text.should =~ /Doctoral Programs in Marriage and Family Therapy/
    # Warning: assertTextNotPresent may require manual changes/^[\s\S]*
