...
describe "NCU Military Testing" do
  ...
  it "verify that a text exists in the page and is not returning an error 404" do
    @driver.get(@base_url + "/Military_Testing/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
    # Warning: assertTextPresent may require manual changes
    @driver.find_element(:tag_name => "body").text.should =~ /Online Education at a Higher Degree/
 ...
 it "check the page for embeded scripts (GA / GTM / Liveball / Conversion Frame)" do
    @driver.get(@base_url + "/Military_Original/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
    # Warning: assertTextPresent may require manual changes
    @driver.find_element(:tag_name => "body").text.should =~ /Online Education at a Higher Degree/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
  ...
  it "form will catch submission of step 1 without selecting Edu level and Interest" do
    @driver.get(@base_url + "/Military_Testing/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /Online Education at a Higher Degree/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
  ...
  it "verify that the form catches invalid Zip and Phone entry" do
    @driver.get(@base_url + "/Military_Testing/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /Online Education at a Higher Degree/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
    ...
    @program.each do |d|
    	if (d.text == "MAPsy - General Psychology")
    	d.click()
    		break
    	end
    end
  ...
  it "verify that the form catches invalid Emails" do
    @driver.get(@base_url + "/Military_Testing/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /Online Education at a Higher Degree/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
  ...
  it "submit with valid information and verfy that a Thank you page exists - Undergrad" do
    @driver.get(@base_url + "/Military_Testing/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /Online Education at a Higher Degree/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
    ...
    (@driver.find_elements(:css, "input.pf_field_row_bad").size).should_not == 1
    # Warning: assertTextPresent may require manual changes
    @driver.find_element(:css, "BODY").text.should =~ /THANK YOU/
  end
