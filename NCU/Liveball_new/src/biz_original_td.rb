...
describe "NCU Business Original - TradeDesk" do
  ...
  after(:all) do
   ...
   it "verify text in page exists and not returning an error 404" do
    @driver.get(@base_url + "/Business_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
    # Warning: assertTextPresent may require manual changes
    @driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF BUSINESS AND TECHNOLOGY/
   ...
   it "submit step 1 without selecting Education and Interest" do
    @driver.get(@base_url + "/Business_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF BUSINESS AND TECHNOLOGY/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
   ...
   it "verify transition to step 2 of the form" do
    @driver.get(@base_url + "/Business_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF BUSINESS AND TECHNOLOGY/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
   ...
   it "test the validation of the form for Zip and Phone fields" do
    @driver.get(@base_url + "/Business_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
    @education_select = @driver.find_element(:name=> "EDUComplete")
    @education = @education_select.find_elements(:tag_name => "option")
    @education.each do |a|
   ...
   it "input invalid Email user with different refactoring" do
    @driver.get(@base_url + "/Business_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF BUSINESS AND TECHNOLOGY/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
   ...
   it "submit with valid information and verify a thank you page exists - Graduate" do
    @driver.get(@base_url + "/Business_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF BUSINESS AND TECHNOLOGY/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
   ...
   it "submit with valid information and verify a thank you page exists - Undergrad" do
    @driver.get(@base_url + "/Business_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF BUSINESS AND TECHNOLOGY/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
