...
describe "NCU Business Testing - TradeDesk" do
  ...
  it "verify a text exists in a page and not returning an error 404" do
    @driver.get(@base_url + "/Business_Testing_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
  ...
  it "submit step 1 of the form without selecting Education and Interest" do
    @driver.get(@base_url + "/Business_Testing_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
  ...
  it "verifies that the step 2 of the form exists" do
    @driver.get(@base_url + "/Business_Testing_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
  ...
  it "test out the validation of the form in handling invalid Email" do
    @driver.get(@base_url + "/Business_Testing_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
    #workaround for the missing dropdown selection during the export from the IDE
    @education_select = @driver.find_element(:name=> "EDUComplete")
    @education = @education_select.find_elements(:tag_name => "option")
