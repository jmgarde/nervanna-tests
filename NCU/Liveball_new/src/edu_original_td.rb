...
describe "NCU Education Original - TradeDesk" do
  ...
  it "check the page for a text and verify the page is  not returning an error 404" do
    @driver.get(@base_url + "/Education_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
