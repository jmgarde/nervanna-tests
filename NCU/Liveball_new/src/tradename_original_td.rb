...
describe "NCU Tradename Original - TradeDesk" do
  ...
  it "vefiy that a text exists in a page and not returning an error 404" do
    @driver.get(@base_url + "/Tradename_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
