...
describe "NCU Psychology Original - TradeDesk" do
  ...
  it "verify that a text exist in the page and is not returning an error 404" do
    @driver.get(@base_url + "/Psychology_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
    # Warning: assertTextPresent may require manual changes
    @driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF PSYCHOLOGY/
  ...
  it "verify that the form will catch submission without selected Edu leve and Interest" do
    @driver.get(@base_url + "/Psychology_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF PSYCHOLOGY/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
  ...
  it "submit step 1 with valid selection and verify that step 2 exists" do
    @driver.get(@base_url + "/Psychology_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF PSYCHOLOGY/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
  ...
  it "submit and verify that the form catches invalid Zip and Phone entry" do
    @driver.get(@base_url + "/Psychology_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF PSYCHOLOGY/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
  ...
  it "verify that the form will catch invalid Email" do
    @driver.get(@base_url + "/Psychology_Original_TD/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF PSYCHOLOGY/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
