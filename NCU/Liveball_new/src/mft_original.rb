...
describe "NCU MFT Original" do
  ...
  it "verify that a text in a page exists and not returning an error 404" do
    @driver.get(@base_url + "/MFT_Original/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
    # Warning: assertTextPresent may require manual changes
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF MARRIAGE AND FAMILY SCIENCES/
  ...
  it "form will catch step 1 submission without any Edu leve and Interest" do
    @driver.get(@base_url + "/MFT_Original/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF MARRIAGE AND FAMILY SCIENCES/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
  ...
  it "submit step 1 with valid information and verify step 2 exists" do
    @driver.get(@base_url + "/MFT_Original/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF MARRIAGE AND FAMILY SCIENCES/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
  ...
  it "verify that the form catches the invalid Zip and Phone entry" do
    @driver.get(@base_url + "/MFT_Original/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF MARRIAGE AND FAMILY SCIENCES/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
  ...
  it "form catches the invalid Email" do
    @driver.get(@base_url + "/MFT_Original/?LID1=KW&ckm_key=iKYsdeFiwxk&ckm_campaign_id=2071&PN=888-560-1681")
	@driver.find_element(:tag_name => "body").text.should =~ /SCHOOL OF MARRIAGE AND FAMILY SCIENCES/
	@driver.find_element(:tag_name => "body").text.should_not =~ /404/
	@driver.find_element(:tag_name => "body").text.should =~ /Step 1 of 2/
