...
describe "Art Schools Online - Grants Photography - OID = 905" do
  ...
  it "check the page if exists and not returning a 404" do
     @driver.get(@base_url + "grants/photography/?oid=905&lid1=AIO_photo")
  ...
  it "input invalid zip code and notify user" do
    ...
    @driver.find_element(:css, "input[name='AddressZip']").send_keys "6aaaa"
    #workaround for the missing dropdown selection during the export from the IDE
